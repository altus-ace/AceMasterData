...
IF OBJECT_ID(@ConnectionString) IS NOT NULL
   BEGIN
...
SET  @SqlString = 
		...
		'SELECT		[LstNppesNPIKey], [srcFileName], [DataDate], ' +  Convert(varchar, GETDATE()) +',BoomiDbUser' + '
		, '+ CONVERT(varchar, GETDATE()) +', BoomiDbUser ' + ', [NPI], [EntityType], [EIN], [LBN], [LBN_Name]
